...
<jsp:useBean id="searchList" scope="request"
...
<%
							...
							searchResultsList = (List) request.getAttribute("searchList");
							System.out.println("searchResultsList in jsp:"+searchResultsList);
					...
					<tbody>
						...
						if(!searchResultsList.isEmpty()){
							for(int i=0;i<searchResultsList.size();i++){
								resultsList=((List)searchResultsList.get(i));
							
							System.out.println("resultsList in jsp:"+resultsList);
							...
							<% if(resultsList.get(0) != null){
									%>
							<td><%=resultsList.get(0).toString()%></td>
							<%}else{ %>
							<td></td>
							<%} %>
							<td><%=resultsList.get(1).toString()%></td>
							<td><%=resultsList.get(2).toString()%></td>
							<% if(resultsList.get(3) != null){ 
							 String emailIdStr = resultsList.get(3).toString();
							 String[] userId;
							 if(emailIdStr.contains("@")){
							   String delimiter = "@";
							   userId =  emailIdStr.split(delimiter);
							 }else{
							   userId = resultsList.get(3).toString().split("\n");
							 }
							   %>
							...
							<td><%=resultsList.get(3).toString()%></td>
							<%}else{ %>
							<td></td>
							<td></td>
							<% }		
